...
export const products = [
  {
    ...
    description: [
      ...
      "The internal storage of the PlayStation 5 is a custom-built 825 GB solid-state drive (667 GB available) with a 12-channel interface, achieving a raw throughput of 5.5 GB/s. ",
      "The launch unit is a two-tone design matching the design of the DualSense controller, with a black internal block flanked by two white wings along its sides, each lit by blue LEDs.",
      "The DualSense wireless controller for the PlayStation 5 was revealed on April 7, 2020. It is based on the prior DualShock controller but with modifications influenced by discussions with game designers and players.",
      "The PlayStation 5 supports Popcornflix, Crackle, Crunchyroll, Niconico, AbemaTV, YouTube, YouTube TV, Netflix, Red Bull TV, Disney+ and much more",
    ],
  },
  {
    _id: "1112",
  ...
  },
  {
    ...
    description: [
      ...
      "PAI (Personal Activity Intelligence) – Single matrix to track your all fitness related activities. Tracks 11 professional sports mode (including Yoga and Rope skipping). Run on the go with Automatic activity detection (Running and Walking).",
  ...
  },
  {
    ...
    description: [
      "Processor: 12th Generation Intel Core i5-1235U Processor(1.3 GHz up to 4.4 GHz, 12 MB L3 Cache) | Memory: 16 GB LPDDR4x Memory (On BD 16 GB) | Storage: 512 GB NVMe SSD",
      ...
      "Ports: 1 HDMI, 1 Thunderbolt 4, 1 USB Type-C, 1 USB3.2, MicroSD Multi-media Card Reader, 1 Headphone out/Mic-in Combo, | Without CD-drive | Average battery life = 61.1 Wh (upto 22hrs video play), 65 W USB Type-C Adapter",
  ...
  },
  {
    ...
    description: [
      ...
      "Memory: 8 GB DDR4-2400 SDRAM (1 x 8 GB); Storage: 256 GB SSD storage; 1TB HDD storage",
      "Display: 23.8 diagonal FHD (1920 x 1080), IPS, three-sided micro-edge, anti-glare, 250 nits, 72% NTSC",
      "Operating System: Microsoft Windows 10 - Home edition; Microsoft Office 2019 - Home and Student Edition",
      "Voice Assistant: Alexa Built-in and Minimum Dimensions (W x D x H): 54.08 x 20.45 x 40.93 cm; Weight: 5.85 kg",
      "Graphics: AMD Radeon Graphics | Audio: Dual 2 W speakers",
      "Keyboard & Mouse: USB black wired keyboard and mouse",
      "Ports: 2 SuperSpeed USB Type-A 5Gbps signaling rate; 2 USB 2.0 Type-A; 1 headphone/microphone combo",
    ],
  },
  {
    _id: "1123",
    ...
    description: [
      ...
      "Windows 8.1 or Windows 7 SP1 64 bit or newer Operating System required, Windows PC and internet connection required - review recommended specs to confirm system compatibility",
    ],
  },
];
